...
class MaskCollator(object):
    ...
    при этом предиктор предиктит все разом

    это не блочная как в статье!! это аналогично другой архитектуре (MAE, Masked AutoEncoder), но имеет место быть в работе
    в том числе для маленьких датасетов типа cifar10 и cifar100

    он если что вписывается в dataloader, в collate_fn аттрибут)
    """
    def __init__(
        self,
        ratio=(0.4, 0.6),
